...
const generateMockUsers = (): User[] => [
  {
    ...
    image: require("@/assets/images/furry.jpg"),
  },
  {
    id: 2,
    name: "Sam",
    ...
    image: require("@/assets/images/furry2.jpg"),
  },
  {
    id: 3,
    name: "Jordan",
    ...
    image: require("@/assets/images/furry3.jpg"),
  },
  {
    id: 4,
    name: "Casey",
    ...
    image: require("@/assets/images/furry4.jpg"),
  },
  {
    id: 5,
    name: "Morgan",
    ...
    image: require("@/assets/images/morgan.png"),
  },
  {
    id: 6,
    name: "Riley",
...
export default function HomeScreen() {
  ...
  const handlePass = (userId: number) => {
    ...
    const filteredUsers = users.filter(
      (user) => !passedUsers.has(user.id) && user.id !== userId
    );
  ...
  const UserCard = ({ user }: { user: User }) => (
    <ThemedView style={styles.card}>
      ...
      <View style={styles.cardContent}>
        ...
        <ThemedText style={styles.cardBio}>{user.bio}</ThemedText>
      </View>
    </ThemedView>
  );
    ...
    >
      <ThemedView style={styles.container}>
        ...
        {currentUser && (
          <TouchableOpacity
            style={[
              styles.passButtonFixed,
              { backgroundColor: "#ff4458", left: 20, right: undefined },
            ]}
